...
musicPaused = False
override_button = pygame.image.load("Override.png")
...
class Background():
    ...
    def setTiles(self, tiles):
        ...
        screen.blit(override_button,(630,730))
        pygame.display.flip()
...
def drawRect(xpos, ypos, width, height, colour, linewidth=0):
    ...
    text = font.render("Override",True,(0xff,0xff,0xff,0xff))
...
def buttonClicked(button):
    ...
    button_position_rect = pygame.Rect(630,730,400,400) #xpos,ypos,width and height of 200 pixels
    button_position_rect.collidepoint(pos)
    button_position_rect = override_button.get_rect()
    button_position_rect = button_position_rect.move(630,730)
    if button_position_rect.collidepoint(pos):
...
#     print(click)
#     if override_button.get_rect().collidepoint(mouse):
#         if click[0]==1:
#             print("button press")
#
#
