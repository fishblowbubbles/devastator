...
def listeningFunc(source):
    ...
    audio = r.record(source, duration=5)  # record 5s of the source (method 2 may be better)
    writeToWav(audio)
...
#        print ("Fear: %.3f" % emotionProbabilities.fear)
    ...
    voice.destroy()
    os.remove(filenamelist[counter-1]) #deletes file after processing to save space
